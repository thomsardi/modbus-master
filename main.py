...
if __name__ == "__main__" :
    ...
    scanner = MpptSrne(method='rtu', port=portName, timeout=0.2, baudrate=9600)
    # scanner.startId = 1
    # scanner.endId = 15 #avoid scanning id > 250
    ...
    while(1) :
        ...
        print(modbusHandler.mpptDataCollection.getInfo())
        count += 1
        if count >= 50 :
